...
if ($ldap->connect()) { // Intenta conectar al servidor LDAP
    ...
    if ($ldap->authenticateUserSistemas($username, $password)) {  // Intenta autenticar al usuario
       ...
       // Crear una instancia de la clase Empleado
        ...
        if (!empty($empleado)){
            ...
            $_SESSION['empleadoSistemas'] = $empleado;
...
<div class="col-9 bgLoginSistemas dark-overlay">



<div class="container vh-100 d-flex align-items-end pb-5 text-white">
...
<div class="container vh-100 d-flex align-items-center ">
        ...
        <div class="p-4">
            ...
            <div class=" mb-5 row text-center">
                <h1 class="col-12">Prototipo Ticketera</h1>
                <p class="col-12">Sistemas</p>
            </div>
            ...
            <?php
                            if (isset($error_message)) {
                                echo '<div class="text-danger mt-2 text-center">' . $error_message . '</div>';
                            }
                            ?>
        </div>
...
<div class="d-flex align-items-center col-4">
    ...
    <div class="container border border-black rounded-5 mt-5">
        <h1 class="fs-5 m-0 p-2">Login</h1>
        <div class="row d-flex justify-content-center border-top p-4">
            <div class="col-5 d-flex align-items-center">
                <h1>Prototipo Ticketera</h1>
            </div>
            <div class="border-start col-5 d-flex justify-content-center">
                <form method="post" action="login.php">
                    <label for="usuario" class="form-label">Usuario</label>
