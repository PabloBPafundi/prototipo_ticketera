...
session_start();
 ...
 if (!isset($_SESSION['empleadoSistemas'])) {
 ...
 exit();
  ...
  $empleadoActual = $_SESSION['empleadoSistemas'];
...
<div class="mx-3">
    ...
    <a class="nav-link active bg-black text-white p-2 rounded-2" href="./ticketera.php">Ticketera</a>
    ...
    <li class="nav-item dropdown">
          ...
          <li><a class="dropdown-item" href="./registro-tickets.php">Registro de Tickets</a></li>
            ...
            <li><a class="dropdown-item" href="./mis-casos.php">Mis Casos</a></li>
